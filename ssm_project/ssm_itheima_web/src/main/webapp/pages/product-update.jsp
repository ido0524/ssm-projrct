                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right" value="${product.departureTimeStr}"
                        ...
                        <div class="col-md-4 data">
                            <select class="form-control select2" style="width: 100%"
                                    name="productStatus">
                                <option value="0" <%--selected="selected"--%> ${product.productStatus == 0 ? "selected" : ""}>关闭</option>
